...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\x1a proto/shared/session_types.proto2V\n" +
	"\vAuthService\x12G\n" +
	"\x17SendSessionToMiddleware\x12\x13.shared.SessionData\x1a\x17.shared.SessionResponseB\x14Z\x12evolvia/proto/authb\x06proto3"
