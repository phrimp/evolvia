...
type SessionData struct {
	...
	Device         *shared.Device         `protobuf:"bytes,9,opt,name=device,proto3" json:"device,omitempty"`
	Location       *shared.Location       `protobuf:"bytes,10,opt,name=location,proto3" json:"location,omitempty"`
...
func (x *SessionData) GetDevice() *shared.Device {
	if x != nil {
		return x.Device
	}
	return nil
...
func (x *SessionData) GetLocation() *shared.Location {
	if x != nil {
		return x.Location
	}
	return nil
...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\x1a\x19proto/shared/common.proto\"\xd3\x02\n" +
	...
	"\vAuthService\x12C\n" +
	"\x17SendSessionToMiddleware\x12\x11.auth.SessionData\x1a\x15.auth.SessionResponseB\x14Z\x12evolvia/proto/authb\x06proto3"
...
var (
	file_proto_auth_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_proto_auth_auth_proto_goTypes  = []any{
		(*SessionData)(nil),     // 0: auth.SessionData
		(*SessionResponse)(nil), // 1: auth.SessionResponse
		(*shared.Device)(nil),   // 2: common.Device
		(*shared.Location)(nil), // 3: common.Location
	}
)

var file_proto_auth_auth_proto_depIdxs = []int32{
	2, // 0: auth.SessionData.device:type_name -> common.Device
	3, // 1: auth.SessionData.location:type_name -> common.Location
	0, // 2: auth.AuthService.SendSessionToMiddleware:input_type -> auth.SessionData
	1, // 3: auth.AuthService.SendSessionToMiddleware:output_type -> auth.SessionResponse
